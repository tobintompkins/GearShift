...
import { Vehicle, ServiceType, JobTemplate } from '@/lib/types';

export default function NewTorqueSpecPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/torque-specs', {
        method: 'POST',
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to create torque spec');
      }
      ...
      <main className="container mx-auto px-4 py-4 md:py-8 max-w-4xl">
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-sm md:text-base text-gray-600">
            Create a new torque specification reference
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md p-4 md:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                placeholder="e.g., Lug nuts, Caliper bracket bolts, Axle nut"
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <p className="text-xs text-gray-500 mt-1">For components that require a specific tightening sequence</p>
          </div>

          {/* Attachments */}
          <div className="border-t border-gray-200 pt-4">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Attach To (Optional - select one or more)</h2>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Additional notes about this torque spec..."
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {loading ? 'Creating...' : 'Create Torque Spec'}
            </button>
            <Link
              href="/torque-specs"
